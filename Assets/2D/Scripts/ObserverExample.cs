...
public class ObserverExample : MonoBehaviour
{
	...
	public UnityEvent onFunctionStart;//DelegateFunction onFunctionStart;       // Will hold references to methods with no parameters
	public UnityEvent<int> onFunctionStop;//IntDelegateFunction onFunctionStop;     // Will hold references to methods that accept an int parameter

	//Unity Actions Only Return Void
